...
def get_rendered_default_code(product, mask):
    ...
    for template_value in product.product_template_attribute_value_ids:
        value = template_value.product_attribute_value_id
...
class ProductTemplate(models.Model):
    ...
    code_prefix = fields.Char(string='Reference Prefix', help='Add prefix to product variant reference (default code)')
...
class ProductAttributeValue(models.Model):
    ...
    def write(self, vals):
        ...
        for product in self.env['product.product'].\
                search([('product_tmpl_id', 'in', self.attribute_id.product_tmpl_ids.ids)]).\
